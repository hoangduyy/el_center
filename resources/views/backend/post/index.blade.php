                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- From search -->
                            <form method="GET" action="{{ route('be.post.index') }}" class="mb-5" id="form-search">
                                <div class="form-row">
                                    <div class="col-md-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="comment-footer d-flex">
                                                    <a href="{{ route('be.post.edit', ['post' => $entity->id]) }}">
                                                        <button type="button" class="btn btn-cyan btn-xs">Sửa</button>
                                                    </a>
                                                    <form action="{{ route('be.post.destroy', ['post' => $entity->id]) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
