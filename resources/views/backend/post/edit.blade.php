                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="card">
                                <form class="form-horizontal" id="form" action="{{route('be.post.update', ['post' => $data->id])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="title" required placeholder="Nhập tiêu đề tin tức" value="{{ $data->title }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <img src="{{ asset($data->thumbnail) }}" alt="" width="100px">
                                                    </div>
                                                </div>
