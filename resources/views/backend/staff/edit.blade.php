                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="card">
                                <form class="form-horizontal" id="form" action="{{route('be.staff.update', ['staff' => $data->id])}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="email" class="form-control" name="email" required placeholder="Nhập email" value="{{$data->email}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input autocomplete="new-password" type="password" class="form-control" name="password_new" placeholder="Nhập password" value="">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Xác nhận mật khẩu mới*</label>
                                                    <div class="col-sm-8">
                                                        <input type="password" class="form-control" name="password_new_confirmation" placeholder="Nhập lại password" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
