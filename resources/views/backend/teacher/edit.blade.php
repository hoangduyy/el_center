                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="card">
                                <form class="form-horizontal" id="form" action="{{route('be.teacher.update', ['teacher' => $data->id])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                                        ...
                                                        <div class="my-select2">
                                                            <select class="my-select2__select2 select2-wrapper" multiple name="certificate_id[]" required>
                                                                @foreach($certificate as $item)
                                                                    <option value = "{{ arrayGet($item, 'id') }}"
                                                                            {{ in_array(arrayGet($item, 'id'), !empty(old('certificate_id', [])) ? old('certificate_id', []) : $teacherCertificate) ? "selected" : '' }}>
                                                                        {{ arrayGet($item, 'name') }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
