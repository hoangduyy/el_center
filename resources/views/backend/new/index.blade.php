                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- From search -->
                            <form method="GET" action="{{ route('be.new.index') }}" class="mb-5" id="form-search">
                                <div class="form-row">
                                    <div class="col-md-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="comment-footer d-flex">
                                                    <a href="{{ route('be.new.edit', ['new' => $entity->id]) }}">
                                                        <button type="button" class="btn btn-cyan btn-xs">Sửa</button>
                                                    </a>
                                                    <form action="{{ route('be.new.destroy', ['new' => $entity->id]) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
