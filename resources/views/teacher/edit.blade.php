                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="card">
                                <form class="form-horizontal" id="form" action="{{route('t.profile.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="name" required
                                                               placeholder="Nhập tên" value="{{$data->name}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="tel" class="form-control" name="phone" required
                                                               placeholder="Nhập sđt" value="{{$data->phone}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="form-control" name="birthday" required value="{{$data->birthday}}">
                                                    </div>
                                                </div>
                                                        ...
                                                        <select class="my-select2__select2 select2-wrapper" name="degree_id" required>
                                                            ...
                                                            @foreach($degree as $item)
                                                                <option value = "{{ arrayGet($item, 'id') }}"
                                                                        {{ $data->degree_id == arrayGet($item, 'id') ? "selected" : '' }}>
                                                                    {{ arrayGet($item, 'name') }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="my-select2">
                                                            <select class="my-select2__select2 select2-wrapper" name="certificate_id[]" multiple required>
                                                                @foreach($listCertificate as $item)
                                                                    <option value = "{{ arrayGet($item, 'id') }}"
                                                                            {{ in_array($item->id, $teacherCertificate) ? "selected" : '' }}>
                                                                        {{ arrayGet($item, 'name') }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <fieldset id="group2" style="position: relative; top: 8px">
                                                            <input type="radio" value="{{\App\Models\Teacher::GENDER_GIRL}}" name="gender"
                                                                    {{ $data->gender ==  \App\Models\Teacher::GENDER_GIRL ? 'checked' : ''}}>
                                                            Nữ &nbsp;&nbsp;&nbsp;
                                                            <input type="radio" value="{{ \App\Models\Teacher::GENDER_BOY }}" name="gender"
                                                                    {{ $data->gender ==  \App\Models\Teacher::GENDER_BOY ? 'checked' : ''}}>
                                                            Nam
                                                        </fieldset>
                                                    </div>
                                                </div>
