    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                ...
                <!-- Form -->
                <form class="form-horizontal mt-3" action="{{ route('t.login.post') }}" method="POST">
                    @csrf

                    @include('teacher.layout.structures._notification')
                    @include('teacher.layout.structures._error_validate')
